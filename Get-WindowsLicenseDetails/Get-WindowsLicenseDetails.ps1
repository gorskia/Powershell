...
Process {
    ...
    foreach ($Computer in $ComputerName) {
        ...
        try {
            ...
            $GracePeriodRemaining = @{Label=”Grace period (days)”; Expression={“{0:N0}” -f ($_.graceperiodremaining / 1440)}}
            ...
            $LicenseInfo | Select-Object PSComputerName, Name, @{N = 'LicenseStatus'; E={$LicenseStatus}},GenuineStatus, $GracePeriodRemaining, PartialProductKey, RemainingSkuReArmCount #, ApplicationID
            }
        catch {
