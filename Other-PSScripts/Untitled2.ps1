...
Process {
    ...
    foreach ($Computer in $ComputerName) {
        ...
        try {
            ...
            $LicenseInfo = Get-CimInstance -Query $Query -CimSession $Cimsession -ErrorAction Sto
            $GracePeriodRemaining = @{Label=”Grace period (days)”; Expression={$_.graceperiodremaining / 1440}}
            ...
            $LicenseInfo | Select-Object PSComputerName, Name, @{N = 'LicenseStatus'; E={$LicenseStatus}},GenuineStatus, $GracePeriodRemaining, PartialProductKey, RemainingSkuReArmCount, IsKeyManagementServiceMachine #, ApplicationID
            }
        catch {
